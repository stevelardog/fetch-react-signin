...
const Footer = () => {
  return (
    <div className='mt-8 pt-8 py-6 bg-[#1f001e] text-white'>
                ...
                <div className='w-full md:w-[300px] py-4 relative'>
                    ...
                    <div className='py-4'>
                        <form>
                            ...
                            <button className= 'text-btnText px-4 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl md:w-auto my-2 bg-orange-500'>Sign Up</button>
                        </form>
                    </div>
